            ...
            <table class="table table-bordered table-striped table-hover custom_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="#" id="restore" data-toggle="modal" data-target="#restoreModal" data-id="{{$data->expense_id}}"><i class="fa fa-recycle fa-lg edit_icon"></i></a>
                    <a href="#" id="delete" data-toggle="modal" data-target="#deleteModal" data-id="{{$data->expense_id}}"><i class="fa fa-trash fa-lg delete_icon"></i></a>
                </td>
                </tr>
                @endforeach
              </tbody>
...
<div class="modal fade" id="restoreModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="{{url('admin/expense/restore')}}">
      @csrf
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="{{url('admin/expense/delete')}}">
      @csrf
      <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-gg-circle"></i> Confirm Message</h5>
